# This file has been refactored - see simulation_minimal.py for Pyodide-compatible version
# Keeping this file for reference but it contains methods that require matplotlib/scipy/sklearn
# The entrypoint (alphasolver_entry.py) uses a minimal Simulation class
